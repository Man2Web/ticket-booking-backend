...
const eventTicketRoutes = require("./api/routes/eventTicketRoutes");
const eventCouponRoutes = require("./api/routes/eventCouponRoutes");
...
app.use("/events/:eventId/tickets", eventTicketRoutes);
app.use("/events/:eventId/coupons", eventCouponRoutes);
